...
from AllItems.Calculation import compute_max_bid
...
def main():
    ...
    if st.button("Calculer l'enchère maximale"):
        ...
        E = compute_max_bid(PR, site_fee_rate, house_fee_rate, live_fee_rate, margin_rate, L)

        # Calculs complémentaires pour afficher un résumé
        net_revenue = PR * (1 - site_fee_rate) - L
        purchase_cost = E * (1 + house_fee_rate + live_fee_rate)
